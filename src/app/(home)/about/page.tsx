...
export default function AboutPage() {
  ...
  return (
    <div className="w-full bg-white text-neutral-900">
      ...
      <AboutSection hideReadMore certificateUrl={certificateUrl} />
      <TeamSection />
          ...
          <div className="max-w-7xl mx-auto px-[10px] md:px-6 flex flex-col gap-12">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm text-neutral-500 max-w-2xl leading-relaxed">
                Dominion Group Ltd operates with full regulatory transparency. Below you will find our official company registration record and supporting compliance documents for your review.
              </p>
            </div>
