...
export default function AboutPage() {
  ...
  const showSection = docsLoaded && (hasLink || hasDocs || hasCert);
          ...
          <div className="max-w-7xl mx-auto px-[10px] md:px-6 flex flex-col gap-12">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm text-neutral-500 max-w-2xl leading-relaxed">
                Dominion Group Ltd operates with full regulatory transparency. Below you will find our official company registration record, compliance certificates, and supporting documents.
              </p>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              {/* Left Column: Docs & Registration Links */}
              <div className={`flex flex-col gap-8 ${hasCert ? "lg:col-span-8" : "lg:col-span-12"}`}>
                {/* Registration Link */}
                {hasLink && (
                  <div className="flex flex-col gap-3">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-3 bg-white border border-neutral-200 rounded p-5 hover:border-[#528574] hover:shadow-md transition-all duration-200 group w-full"
                    >
                ...
                {hasDocs && (
                  <div className="flex flex-col gap-4">
                    ...
                    <div className={`grid grid-cols-1 gap-4 ${hasCert ? "sm:grid-cols-2" : "sm:grid-cols-2 lg:grid-cols-3"}`}>
                      {documents.map((doc, i) => (
                        <a
                          key={i}
                          href={doc.url}
                            ...
                            <div className="flex items-center gap-1.5 mt-1 flex-wrap">
                              ...
                              {doc.language && (
                                <>
                                  ...
                                  <span className="text-[10px] text-[#528574] font-extrabold uppercase tracking-wider">
                                    {doc.language}
                                  </span>
                                </>
                              )}
              ...
              {/* Right Column: Certificate Portrait display */}
              {hasCert && (
                <div className="lg:col-span-4 flex flex-col gap-3 items-center lg:items-start w-full">
                  <h3 className="text-xs font-extrabold uppercase tracking-widest text-neutral-500">Company Certificate</h3>
                  <a
                    href={certificateUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="relative w-full max-w-[280px] aspect-[1/1.414] rounded-lg overflow-hidden border border-neutral-200/80 shadow-lg bg-white group hover:shadow-2xl hover:border-[#528574] transition-all duration-300 flex items-center justify-center cursor-pointer"
                  >
                    <Image
                      src={certificateUrl}
