        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            <p className="text-sm sm:text-base text-white/70 leading-relaxed max-w-xl">
              Dominion Group SA brings institutional-grade investment infrastructure to individual and corporate investors worldwide. Our integrated approach combines high-efficiency refining, disciplined crude production, and proven project management — delivering consistent returns backed by real, tangible energy assets.
            </p>
